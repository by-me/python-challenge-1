...
while place_order:
    ...
    if menu_category.isdigit():
        ...
        if int(menu_category) in menu_items.keys():
            ...
            if menu_selection.isdigit():
                ...
                if menu_selection in menu_items:
                    ...
                    while True:
                        quantity = input(f"How many {item_name}s would you like? (minimum is 1) ")
                        ...
                        # Default to 1 if invalid input is given
                            print("Invalid input. The quantity will default to 1.")
                            quantity= 1
                            break # Exit the loop when defaulting to 1
                ...
                # Tell the customer they didn't select a valid menu option
                    ...
                    print("Invalid menu selection. Please select a valid item.")
            else:
        ...
        while True:
            ...
            # Keep ordering , Complete the order
            match keep_ordering:
                case 'y':
                    place_order = True
                    break  # Exit the loop to continue ordering
            #Since the customer decided to stop ordering, thank them for thier order
                case 'n':
                    place_order = False
                    print("Thank you for your order.")
                    break  # Exit the loop to finish ordering
                case _:   
...
for order in order_list:
    ...
    print(f"{item_name}{item_spaces}| ${price:.1f}{price_spaces}| {quantity}{quantity_spaces}")
